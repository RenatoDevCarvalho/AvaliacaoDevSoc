...
<html>
  ...
  <body class="bg-secondary">
    ...
    >
      ...
      <a class="navbar-brand text-dark border-bottom border-primary" href="${relatorio}">Relatório de consultas</a>
    ...
    <div class="container">
      ...
      <div class="row">
        <table class="table table-light table-striped align-middle">
          <thead>
            <tr>
              <th class="text-center"><s:text name="label.id" /></th>
              <th class="text-center"><s:text name="label.codigo.exame" /></th>
              <th class="text-center"><s:text name="label.nome.exame" /></th>
              <th class="text-center">
                <s:text name="label.codigo.funcionario" />
              </th>
              <th class="text-center">
                <s:text name="label.nome.funcionario" />
              </th>
              <th class="text-center"><s:text name="label.data" /></th>
            </tr>
          </thead>
          ...
          <tbody>
            <s:iterator value="consultas">
              <tr>
                <td class="text-center">${cdConsulta}</td>
                <td class="text-center">${cdExame}</td>
                <td class="text-center">${nmExame}</td>
                <td class="text-center">${cdFuncionario}</td>
