...
public class ConsultaAction extends Action {
	...
	if (opcaoFuncionario.isEmpty()) {
	    ...
	    consultaVo.setCdFuncionario(opcaoFuncionario.get(0));
	    consultaVo.setCdExame(opcaoExame.get(0));
	...
	business.excluirConsulta(consultaVo.getCdConsulta());
	...
	if (opcaoFuncionario.isEmpty()) {
	    consultaVo = business.buscarConsultaPorCodigo(consultaVo.getCdConsulta());
	    funcionarios = funcionarioBusiness.trazerTodosOsFuncionarios();
	    exames = exameBusiness.trazerTodosOsExames();
	    return EDIT;
	} else {
