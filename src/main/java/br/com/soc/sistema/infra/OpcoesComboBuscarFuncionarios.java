...
public enum OpcoesComboBuscarFuncionarios {
    ...
    static {
        Arrays
                .asList(OpcoesComboBuscarFuncionarios.values())
    ...
    public static OpcoesComboBuscarFuncionarios buscarPor(String codigo)
    ...
    private static Optional<OpcoesComboBuscarFuncionarios> getOpcao(
            String codigo
    ) {
